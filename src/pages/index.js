...
const IndexPage = ({ data }) => (
  <Layout>
    ...
    <div className='imageWrapper' style={{ backgroundImage: `linear-gradient(${configs.cover_overlay_color_rgba},${ configs.cover_overlay_color_rgba }),url(${data.headerImage.childImageSharp.fluid.src})` }}>
      <div className='headerBackground'>
        <div className='container'>
          ...
          <div className='iphonePreview' style={{ backgroundImage: `url(${ configs.device_color === "black" ? data.iphonePreviewBlack.childImageSharp.fluid.src : configs.device_color === "blue" ? data.iphonePreviewBlue.childImageSharp.fluid.src : configs.device_color === "coral" ? data.iphonePreviewCoral.childImageSharp.fluid.src : configs.device_color === "white" ? data.iphonePreviewWhite.childImageSharp.fluid.src : data.iphonePreviewYellow.childImageSharp.fluid.src })` }}>
            ...
            {configs.video_or_screenshot === 'video' && (
             <div className='videoContainer'>
               <video className='screenvideo' autoPlay='autoplay' controls='controls'>
                 <source src={data.videoScreen.publicURL} type={`video/${
            ...
            <div className='downloadButtonsContainer'>
              {configs.playstore_link && (
               <a className='playStoreLink' href={configs.playstore_link}>
                 <Img fixed={data.playStore.childImageSharp.fixed} className='playStore' />
               </a>
               )}
              {configs.appstore_link && (
               <a className='appStoreLink' href={configs.appstore_link}>
                 <Img fixed={data.appStore.childImageSharp.fixed} className='appStore' />
               </a>
               )}
            </div>
               ...
               if (feature.title) {
                 return (
                   <div className='feature'>
                     <div>
                       <span className='fa-stack fa-1x'><i className='iconBack fas fa-circle fa-stack-2x' /> <i className={`iconTop fas fa-${
          ...
          <footer>
            ...
            <div className='footerIcons'>
              {configs.facebook_username && (
               <a href={`https://facebook.com/${configs.facebook_username}`} aria-label='Facebook'><span className='fa-stack fa-1x'><i className='socialIconBack fas fa-circle fa-stack-2x' /> <i className='socialIconTop fab fa-facebook fa-stack-1x' /></span></a>
               )}
              {configs.twitter_username && (
               <a href={`https://twitter.com/${configs.twitter_username}`} aria-label='Twitter'><span className='fa-stack fa-1x'><i className='socialIconBack fas fa-circle fa-stack-2x' /> <i className='socialIconTop fab fa-twitter fa-stack-1x' /></span></a>
               )}
              {configs.github_username && (
               <a href={`https://github.com/${configs.github_username}`} aria-label='GitHub'><span className='fa-stack fa-1x'><i className='socialIconBack fas fa-circle fa-stack-2x' /> <i className='socialIconTop fab fa-github fa-stack-1x' /></span></a>
               )}
              {configs.email_address && (
               <a href={`mailto:${configs.email_address}`} aria-label='Email'><span className='fa-stack fa-1x'><i className='socialIconBack fas fa-circle fa-stack-2x' /> <i className='socialIconTop fas fa-envelope fa-stack-1x' /></span></a>
               )}
            </div>
          </footer>
